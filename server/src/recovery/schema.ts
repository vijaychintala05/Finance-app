...
export const POINT1_RECOVERY_SCHEMA: readonly RecoveryTableSchema[] = [
  ...
  // Encrypted bank details are restored through EncryptedConfigRecoveryService,
  // never through the plain tenant backup payload.
  tenantTable('vendors', ['id', 'organization_id', 'vendor_id', 'name', 'legal_name', 'company_name', 'vendor_type', 'gst_status', 'gstin', 'pan', 'email', 'phone', 'mobile', 'website', 'tax_id', 'currency', 'billing_address', 'shipping_address', 'place_of_supply', 'primary_contact', 'additional_contacts', 'payment_terms', 'default_expense_account_id', 'custom_fields', 'notes', 'payables_balance', 'unused_credits', 'advance_balance', 'active', 'opening_balance', 'created_at', 'updated_at']),
  tenantTable('vendor_attachments', ['id', 'organization_id', 'vendor_id', 'file_name', 'mime_type', 'byte_size', 'sha256_hash', 'uploaded_by', 'created_at', 'deleted_at', 'deleted_by']),
