...
router.delete('/items/:id', requirePermission(['items.archive', 'roles.manage', 'settings.manage_users']), Phase8Controller.deleteItem);
...
router.get('/quotations/:id/pdf', requirePermission('estimates.view'), Phase8Controller.getQuotationPdf);
router.get('/quotations/:id/revisions/:revisionNumber/pdf', requirePermission('estimates.view'), Phase8Controller.getQuotationPdf);
...
router.post('/document-numbering/configure', requirePermission('settings.manage_numbering'), Phase8Controller.configureNumberingSequence);
