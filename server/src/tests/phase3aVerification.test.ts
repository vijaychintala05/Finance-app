...
describe('Phase 3A: Bank Statement Parsers, Reference Extraction & Rules Engine Verification', () => {
  beforeAll(async () => {
    ...
    await db.query(
      `INSERT INTO organizations (id, uuid, public_org_id, org_code, name, owner_user_id) VALUES ($1, $2, $3, $4, $5, $6) ON CONFLICT DO NOTHING`,
...
2026-08-01,ORG B ONLY TX,REF-ORG-B,,2000.00,2000.00`;
    ...
    await BankReconciliationService.importStatement(ORG_B, HDFC_ACC_ID, 'orgB.csv', csvOrgB);
