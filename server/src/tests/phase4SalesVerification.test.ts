  ...
  beforeEach(async () => {
    ...
    await db.query(`
      ...
      VALUES 
        ...
        ('acc-gst-output', '${ORG_ID}', '2100', 'GST Output Liability', 'Liability', 'GST Output Liability', 0.00),
        ('acc-bank-1', '${ORG_ID}', '1010', 'HDFC Bank Account', 'Asset', 'Cash and Cash Equivalents', 0.00),
        ('acc-customer-advances', '${ORG_ID}', '2200', 'Customer Advances Liability', 'Liability', 'Other Current Liabilities', 0.00),
