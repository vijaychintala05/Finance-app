                ...
                accountTransactions.map((tx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3 px-4 whitespace-nowrap">
                        <span className="text-[10px] px-2 py-0.5 rounded font-bold uppercase border bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-950 dark:text-emerald-300 dark:border-emerald-800">
                          Reconciled
                        </span>
                      </td>
                      <td className="py-3 px-4 text-right font-mono font-bold whitespace-nowrap">
                        <span className={isMoneyIn ? 'text-emerald-600 dark:text-emerald-400' : 'text-slate-900 dark:text-white'}>
                          {isMoneyIn ? '+' : '-'}{formatCurrency(tx.amount, currencySymbol)}
                        </span>
                      </td>
