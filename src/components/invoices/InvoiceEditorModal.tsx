...
export const InvoiceEditorModal: React.FC<InvoiceEditorModalProps> = ({
  ...
  const [items, setItems] = useState<InvoiceItem[]>([
    {
      id: `item-${Date.now()}-1`,
      description: 'Professional Advisory & Strategic Consulting Services',
      accountId: revenueAccounts[0]?.id || 'acc-4000',
      quantity: 1,
      unitPrice: 5000,
      ...
      setItems([
        {
          ...
          description: targetProj
            ...
            : 'Professional Advisory & Strategic Consulting Services',
          accountId: revenueAccounts[0]?.id || 'acc-4000',
          quantity: 1,
          unitPrice: targetProj?.totalBudget ? Math.round(targetProj.totalBudget / 2) : 5000,
          taxRate: settings.defaultTaxRate,
          amount: targetProj?.totalBudget ? Math.round(targetProj.totalBudget / 2) : 5000,
        },
      ]);
      setEditReason('');
    }
