...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navSections: NavSection[] = [
    ...
    },
    {
      ...
      defaultTab: 'sales_overview',
      subItems: [
        { id: 'sales_overview', label: 'Overview' },
        { id: 'clients', label: 'Customers' },
        { id: 'estimates', label: 'Quotes' },
        ...
        { id: 'salespersons', label: 'Sales Persons & Reps' },
      ],
    },
    {
      ...
      defaultTab: 'purchases_overview',
      subItems: [
        { id: 'purchases_overview', label: 'Overview' },
    ...
    },
    {
      ...
      defaultTab: 'accounting_overview',
      subItems: [
        { id: 'accounting_overview', label: 'Overview' },
        { id: 'journals', label: 'Manual Journals' },
        { id: 'bulk_updates', label: 'Bulk Updates' },
        { id: 'coa', label: 'Chart of Accounts' },
        { id: 'transaction_locking', label: 'Transaction Locking' },
      ],
    },
    {
      id: 'reports_section',
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: 'settings', label: 'Firm Settings & Data' },
      ],
    },
  ];
